...
namespace TrafficTimetable.Infrastructure
{
    public static class Regexes
    {
        ...
        public static Regex stopAddingRegex = new Regex("хочу добавить остановку", RegexOptions.IgnoreCase);
        public static Regex routeAddingRegex = new Regex("хочу добавить маршрут к тегу", RegexOptions.IgnoreCase);
        public static Regex routeRegex = new Regex(@"[\d]|[\d][\d]|[\d][\d][\D]", RegexOptions.IgnoreCase);
        public static Regex tagRegex = new Regex(@"хочу поехать|я еду|я направляюсь|поехали", RegexOptions.IgnoreCase);
        ...
        public static Regex showAllStopsRegex = new Regex("покажи все мои остановки|покажи мои остановки|покажи мои теги", RegexOptions.IgnoreCase);
